...
export default function Icons (props){
	function getIcons(name,props){
		switch(name){
			...
			case 'PLUS':
				return (<svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-plus" viewBox="0 0 24 24" strokeWidth="1.5" stroke="#ffffff" fill="none" strokeLinecap="round" strokeLinejoin="round" {...props} style={{verticalAlign:'initial'}}>
  					<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
			...
			case 'DOT':
				return(
					<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-dots"  viewBox="0 0 24 24" stroke-width="1.5" stroke="#000000" fill="none" stroke-linecap="round" stroke-linejoin="round" {...props}>
  							<path stroke="none" d="M0 0h24v24H0z" fill="none"/>
